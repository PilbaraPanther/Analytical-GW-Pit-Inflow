...
#written by Tim 2:03 PM 30/08/2019
...
def pit_inflow():
   ...
   # Wlabel = Label('distributed recharge (m/d):')
    
    #Zone 1 horizontal hydraulic conductivity (m/d)
    kh1= widgets.FloatText(
    value=999,
    description='',
    disabled=False
)
    #kh1label = Label('horizontal hydraulic conductivity - zone 1 (m/d):')
